          ...
          <div className="two-step-grid">
            ...
            <section className="task-card">
              ...
              <form className="task-content" onSubmit={importPrescription}>
                ...
                <label className="field"><span>Encrypted prescription code</span><textarea rows={5} value={patientPackage} onChange={(event) => setPatientPackage(event.target.value)} required placeholder="Paste encrypted JSON package from prescriber" /><small>Accepts valid JSON prescription packages generated by Midnight prescriber desk.</small></label>
                {wallet.error && <div className="error-banner" role="alert">{wallet.error}</div>}
